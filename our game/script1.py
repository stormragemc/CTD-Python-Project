...
player = canvas.create_oval(player_position[0] * cell_size + 20, player_position[1] * cell_size + 20,
                            player_position[0] * cell_size + cell_size - 20, player_position[1] * cell_size + cell_size - 20,
                            fill="blue")
